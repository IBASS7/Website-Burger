...
let icon_off = () => {
    Array.from(document.getElementsByClassName('slider_img')).forEach((el) => {
...
document.getElementsByClassName('bi-chevron-right')[0].addEventListener('click', () => {
    ...
    document.getElementById('kalori').innerText = images_dt[(index/310)].calorie;
    ...
    icon_off();
    document.getElementsByClassName('slider_img')[(index/310)].style.transform = "scale(1.1)"
    document.getElementsByClassName('slider_img')[(index/310)].style.opacity = 1;
})
// End
...
// slider
Array.from(document.getElementsByClassName('slider_img')).forEach((el, i)=> {
